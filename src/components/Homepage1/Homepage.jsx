    ...
    return (
        <div className="lg:mx-10 md:mx-5 sm:mx-1 mx-0">
            ...
            <section className="flex flex-col items-start mt-5 pl-2 bg-stone-100 max-md:pl-5 rounded-md pt-3">
                ...
                <div className="flex flex-wrap items-center w-full mt-1 py-7 text-base leading-5 tracking-wider text-center gap-9 text-neutral-800 max-md:max-w-full  rounded-md">
